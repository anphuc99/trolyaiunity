...
/**
 * Stores FSRS spaced-repetition review state for a journal entry.
 * Users re-read journal summaries and rate their recall using 4 levels.
 */
...
class JournalReviewEntity {
  ...
  /** Date/time of the next review. */
  @Column({ name: "next_review_date", type: "datetime" })
  nextReviewDate!: Date;

  /** Date/time of the last review (null if never reviewed). */
