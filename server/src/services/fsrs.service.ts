 ...
 *
 * Wraps the ts-fsrs library to provide scheduling for knowledge reviews.
 * 4-level rating, stability, difficulty, retrievability, and review history tracking.
 */
...
/**
 * Builds the initial review state for a newly created knowledge item.
 * The first review is scheduled immediately so it appears in the review queue.
 *
 ...
 * @param desiredRetention - Target recall probability.
