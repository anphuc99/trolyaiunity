...
/**
 * @deprecated Use signAuthTokenPair instead. Kept for backward compatibility.
 * Signs a JWT for the given user (uses access token expiry).
 *
 * @param user - Authenticated user to include in the token.
...
/**
 * @deprecated Use verifyAccessToken instead. Kept for backward compatibility.
