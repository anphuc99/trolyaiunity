...
namespace Features.GamePlay.SubFeatures.Journal.View
{
	...
	/// </summary>
	public enum JournalMessageBubbleType
	{
		Character = 0,
		User = 1,
	}
	...
	/// </summary>
	[Serializable]
	public sealed class JournalMessageBubbleData
	{
		[SerializeField]
		private string _messageId;

		[SerializeField]
		private JournalMessageBubbleType _type = JournalMessageBubbleType.Character;
		...
		/// Bubble type.
		/// </summary>
		public JournalMessageBubbleType Type
		{
			get => _type;
			set => _type = value;
		}
